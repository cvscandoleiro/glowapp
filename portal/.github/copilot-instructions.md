# Planning 2.0 Project — Copilot Instructions

## M3A Team (Multi-Agent AI Architecture)

The **Planning 2.0** project uses the **M3A Team** multi-agent framework — a structured team of 12 specialized AI agents coordinated through a single orchestrator.
...
**Planning 2.0** (v0.0.0) — Portal de planejamento e acompanhamento de projetos
...
Frontend React + Vite com backend Express e integracao OracleDB. Fluxo principal orientado a visualizacoes de planejamento, backlog e recursos.
...
- Priorizar TypeScript em toda nova implementacao.
- Manter componentes React coesos e orientados por dominio.
- Validar impacto em backend Express antes de mudancas de API.
- Registrar decisoes relevantes em .github/mma/knowledge/project-decisions-log.md.
